<?php
/* ============================================================
   VERO — Compras / exportação CSV (sweep A2/A4)
   Baixa a lista JÁ FILTRADA (as mesmas cláusulas do filtro ativo) em CSV.
   Mesma convenção do motor de relatórios (relatorios/_rel_base.php) e do
   estoque/_export.php: UTF-8 com BOM, separador ';', decimal com vírgula —
   abre direto no Excel pt-BR. Chamado ANTES de qualquer HTML pela tela dona
   do filtro, que passa as linhas já consultadas.
   Fica no módulo (não toca includes/ — C-07). Função genérica `vero_csv_stream`
   guardada por function_exists para poder ser reusada por outras telas do sweep.
   ============================================================ */
